...
@SourceType(value = "BoxARP", label = "Box",uiConfig = "box-layout.json")
public class BoxConf extends AbstractArpConf<BoxConf> {
  private static final String ARP_FILENAME = "arp/implementation/box-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.box.BoxDriver";
